...
#Use 0.01 since that is Adam optimizer default used in p1
nn_rhc = mlrose.NeuralNetwork(hidden_nodes=[3], activation='relu',
                                 algorithm='gradient_descent', max_iters=512,
...
print("Gradient Descent (Benchmark):")
...
nn_rhc = mlrose.NeuralNetwork(hidden_nodes=[3], activation='relu',
                                 algorithm='random_hill_climb', max_iters=512,
                                 bias=True, restarts=100, is_classifier=True, learning_rate=0.01,
...
nn_rhc = mlrose.NeuralNetwork(hidden_nodes=[3], activation='relu',
                                 algorithm='simulated_annealing', max_iters=512,
                                 bias=True, is_classifier=True, learning_rate=0.01,
                                 early_stopping=True, clip_max=5, max_attempts=100,
                                 random_state=3)
s = timeit.default_timer()
...
nn_rhc = mlrose.NeuralNetwork(hidden_nodes=[3], activation='relu',
                                 algorithm='genetic_alg', max_iters=512,
                                 bias=True, is_classifier=True, learning_rate=0.01,
                                 early_stopping=True, clip_max=5, max_attempts=100,
                                 random_state=3)
s = timeit.default_timer()
